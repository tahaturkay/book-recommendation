...
// Her gece saat 03:00'te çalıştırıyoruz bu ırgatı
const startPopularityCron = () => {
    cron.schedule('0 3 * * *', async () => {
        ...
        try {
            ...
            // gözüme hitap eden (bana göre denklik olan) denkleme göre katsayı ayarı
            // 4 yıldızlı 632 oylu kitap = 5 yıldızlı 100 oylu kitap
            const updateQuery = `
                UPDATE "Book"
    ...
    console.log("Cron Job aktif: Kitap popülerlik skorları her gece 03:00'te güncellenecek.");
};
